	...
	<div class="">
		...
		<div class="col-md-12 col-sm-12 col-xs-12">
			<div class="x_panel">
				...
				<div class="x_content">
					<div class="container">
						<a href="<c:url value="/category/add"/>" class="btn btn-app">
							<i class="fa fa-plus"></i>Add new category
						</a>
					</div>
					
					<div class="container">
						<form:form id="categorySearchForm" modelAttribute="categorySearchForm" servletRelativeAction="/category/list/" method="POST" class="form-horizontal form-label-left">
...
<script type="text/javascript">
	 ...
	 function gotoPage(page){
		 $('#categorySearchForm').attr('action','<c:url value="/category/list/"/>' + page);
