		...
		<div class="row">
			<div class="col-md-12 col-sm-12 ">
				<div class="x_panel">
					...
					<div class="x_content">
						<br />
						<form:form servletRelativeAction="/category/save" method="POST" modelAttribute="categoryForm" class="form-horizontal form-label-left">
							...
							<div class="form-group">
								...
								<div class="col-md-6 col-sm-6 col-xs-12">
									<form:input path="description" cssClass="form-control col-md-7 col-xs-12" disabled="${viewMode}" />
									<div class="has-error">
