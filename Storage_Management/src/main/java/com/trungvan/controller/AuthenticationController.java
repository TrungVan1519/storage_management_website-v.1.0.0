...
import com.trungvan.validation.LoginValidator;
...
public class AuthenticationController {
	...
	public String processLogin(Model model, 
		...
		//		toan bo Set User nen trong class Entity User ta phai su dung fetch = FetchType.EAGER ()
		...
		log.info("> Role's name: " + role.getRoleName());
		...
		// > Day la gia thuyet de giai thich, khong chac chan: Co le vi o day khi truy van ta truy van ra 
		//		toan bo Set Auth nen trong class Entity Role ta phai su dung fetch = FetchType.EAGER ()
