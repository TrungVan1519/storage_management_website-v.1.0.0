...
public class FilterSystem implements HandlerInterceptor {
	...
	private static Logger log = Logger.getLogger(FilterSystem.class);
	...
	public boolean preHandle(HttpServletRequest request, HttpServletResponse response, Object handler)
		...
		if(!authenticatedConfirmation(url, user)) {
	...
	private boolean authenticatedConfirmation(String url, User user) {
